...
4. compile the source code & run the binary with `$ g++ Main.cpp -o CollatzConjecture && ./CollatzConjecture`
...
4. compile the source code & run the binary with `$ g++ Main.cpp -o CollazConjecture && ./CollatzConjecture`
